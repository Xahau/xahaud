...
int64_t hook(uint32_t reserved)
{
    ...
    return accept(0, 0, reserved);
        ...
        BEAST_EXPECT(
            ...
            hook::artifact::XFLArithmeticProfile::none);
        expectFuel(successfulValidation.invocationFuelConsumed, 55785);
        ...
        for (auto& validation : concurrentValidations)
        {
            ...
            BEAST_EXPECT(
                ...
                hook::artifact::XFLArithmeticProfile::none);
            expectFuel(result.invocationFuelConsumed, 55785);
        }
        ...
        testcase("Bind API, profile, hash, dedup, and hash install");
        {
            ...
            expectFuel(failedValidation.invocationFuelConsumed, 14087);
            identityEnv(
                jtx::hook(
                    alice,
                    {{hsoVersioned(
        ...
        expectFuel(execution.getFieldU64(sfHookInstructionCount), 60779);
        ...
        BEAST_EXPECT(
            ...
            "xfl add/subtract");
        expectFuel(xflExecution.getFieldU64(sfHookInstructionCount), 291963);
        ...
        BEAST_EXPECT(
            ...
            "xfl multiply");
        expectFuel(
            multiplyExecution.getFieldU64(sfHookInstructionCount), 194694);
        ...
        BEAST_EXPECT(
            ...
            "xfl fixed divide");
        expectFuel(
            fixedDivideExecution.getFieldU64(sfHookInstructionCount), 196515);
        ...
        BEAST_EXPECT(
            ...
            "xfl divide by zero");
        expectFuel(
            divideByZeroExecution.getFieldU64(sfHookInstructionCount), 190533);
        ...
        expectFuel(bypassExecution.getFieldU64(sfHookInstructionCount), 204288);
        ...
        BEAST_EXPECT(
            ...
            "surface:40");
        expectFuel(surfaceExecution.getFieldU64(sfHookInstructionCount), 99898);
        ...
        if (rollbackExecutions.size() != 1)
            return;
        expectFuel(
            rollbackExecutions[0].getFieldU64(sfHookInstructionCount), 80290);
        ...
        expectFuel(
            memoryGrowthExecution.getFieldU64(sfHookInstructionCount), 7488802);
        BEAST_EXPECT(
        ...
        expectFuel(
            callbackExecution.getFieldU64(sfHookInstructionCount), 116541);
        BEAST_EXPECT_EQ(
