...
// Despite the name this category is now used for both non-governance
// participants AND l2 seats specific distributions
inline std::vector<std::pair<std::string, XRPAmount>> const
    NonGovernanceDistribution{
        ...
        {"rGshbE2xPc2Jw66iTAXuX5RjXmJW4ohbrY",
         ExchangeAmount},  // Unannounced Exchange 1
        {"r4vv7gFjtWAUxPWfj5puGNeW9U8FGSn7iu",
         ExchangeAmount},  // Unannounced Exchange 2
        ...
        {"rHrptekd18qAGCADzK1kg2QyREiRPuVpTJ",
         AuditorAmount},  // Danish Blockchain Labs
...
inline std::vector<std::pair<std::string, XRPAmount>>
    TestNonGovernanceDistribution;

inline std::vector<std::pair<std::string, XRPAmount>> const L1Membership{
    {"nHB45nBNgjKMssrRqaNVr2tpCq3t55J5APRRDD6ov1U41JfVFjr6",
     IntPropAmount},  // XRPL-Labs
    {"nHB2tHvDXE2GM3Cp9ivyAXU3NDLkf8mzYREQkcZ7wFJyBiaVLu24",
     InfraAmount},  // Titanium
    {"nHUetpkzTgf8c6A1DTGemRrhL4nMjsiJrtcsmmg75ufzV5EDMbWU",
     InfraAmount},  // Evernode
    {"nHBcpUteNtfXeEquLuXVSAAPKxPigmkLAvmpnPjiiPQ4dWZvkoxi",
     InfraAmount},  // Digital Governance
    {"nHB1BVMv96GUa272VehmoCeGM61uLRHZVbxAG1i9kQ9Xzd1KVrh1",
     MarketMakerAmount},  // GateHub

    {"nHBVzNWFu2yT373tTto5HT1Tybdq2GE8hsdhHdowUDdj9wBieNFo",
     TableAmount},  // L2 Table Projects
    {"nHUzXFEQwBkqHWp71E23fY9QKvEGQqVncJfm8fPxn4bRBYQ3Eee3",
     DevTableAmount},  // L2 Table Community
    {"nHB1Sjz33Aizc4cdKWvKJDhh5BJAKe19PW7hsveZQq83RUcaxoXA",
     TableAmount},  // L2 Table Auditors
    {"nHD9nhqSzzUFEmu8DuRpKrgF1rQzBkjVpMmYhtjmddhGoDLAF63i",
     TableAmount},  // L2 Table Exchanges
};

// this data structure is used for testing the amendment only,
// if the ttEnableAmendment has an optional flag (that cannot be added in
// production) then whatever is in this array is used
inline std::vector<std::pair<std::string, XRPAmount>> TestL1Membership;

inline std::vector<std::pair<
    std::string,                // L2 table account
    std::vector<std::string>>>  // list of initial members
    const L2Membership{
        {"nHBVzNWFu2yT373tTto5HT1Tybdq2GE8hsdhHdowUDdj9wBieNFo",  // L2 Table
                                                                  // Projects
         {"rJFxdrd1BuMeJshRAZBuHP3hex9DjH1nnr",                   // Casino Coin
          "rHMtqVuvEESUhPrsgb8tSa5ghjyoQySfVC"}},                 // xSpectar

        {"nHD9nhqSzzUFEmu8DuRpKrgF1rQzBkjVpMmYhtjmddhGoDLAF63i",  // L2 Table
                                                                  // Exchanges
        ...
        {"nHB1Sjz33Aizc4cdKWvKJDhh5BJAKe19PW7hsveZQq83RUcaxoXA",  // L2 Table
                                                                  // Auditors &
                                                                  // Enterprise
        ...
        {"nHUzXFEQwBkqHWp71E23fY9QKvEGQqVncJfm8fPxn4bRBYQ3Eee3",  // L2 Table
                                                                  // Community
