...
set(XAHAU_QUICKJS_PROVIDER_LOCK
  "${XAHAU_QUICKJS_PROVIDER_BUNDLE_DIR}/jshookz_provider.lock.json")
...
set(XAHAU_QUICKJS_ENTROPY_DECLARATION
  "${XAHAU_QUICKJS_PROVIDER_BUNDLE_DIR}/xahau-quickjs-v1-consensus-entropy.d.ts")
set(XAHAU_QUICKJS_ENTROPY_SURFACE
  "${XAHAU_QUICKJS_PROVIDER_BUNDLE_DIR}/xahau-quickjs-v1-consensus-entropy.surface.json")
...
foreach(_bundle_file
    ...
    "${XAHAU_QUICKJS_ENTROPY_DECLARATION}"
    "${XAHAU_QUICKJS_ENTROPY_SURFACE}"
