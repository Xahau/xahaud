...
4. If desired, create a systemd service file, enabling xahaud to run as a daemon. Alternately, run: `/path/to/binary/xahaud --conf=/path/to/xahaud.cfg`.
...
[Service]
Type=simple
ExecStartPre=+chown -R xahaud /path/to/xahaud
