...
#define sfNotBefore ((3U << 16U) + 29U)
#define sfNotAfter ((3U << 16U) + 30U)
...
#define sfManifestHash ((5U << 16U) + 38U)
#define sfExpectedDomainHash ((5U << 16U) + 39U)
#define sfExpectedValidatorDomainHash ((5U << 16U) + 40U)
#define sfRootSetID ((5U << 16U) + 41U)
...
#define sfManifest ((7U << 16U) + 33U)
#define sfValidatorPublicKey ((7U << 16U) + 34U)
#define sfCertificateChain ((7U << 16U) + 35U)
#define sfDomainSignature ((7U << 16U) + 36U)
#define sfValidatorMasterSignature ((7U << 16U) + 37U)
